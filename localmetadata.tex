...
\textit{\LARGE {\spaceskip=3.5pt Vierte, komplett überarbeitete Auf\/lage}}}
...
Stefan Müller. \lsYear. \textit{Head-Driven Phrase Structure Grammar: Eine Einführung. Vierte,
  komplett überarbeitete Auf\kern0pt lage}. (Textbooks in Language Sciences~\lsSeriesNumber). Berlin: Language Science Press.
}

\typesetter{Stefan Müller}

\proofreader{Bruno Behling, Sebastian Nordhoff, Hannah Schleupner}
...
\noindent
„Der Inhalt des Buches ist komplex und behandelt eine nicht einfache Thematik. Für Studierende
sprachwissenschaftlicher Fächer ist dieses Lehrbuch aber durchaus geeignet und auch in seinem Aufbau
didaktisch wohlüberlegt.“ Jens Fleischhauer. 2010. \emph{Roterdorn}. 
...
\renewcommand{\lsISBNdigital}{978-3-96110-583-0}
%\renewcommand{\lsISBNhardcover}{978-3-98554-066-2} Lehrbuch -> no hardcover
\renewcommand{\lsISBNsoftcover}{978-3-98554-200-0}
\renewcommand{\lsBookDOI}{10.5281/zenodo.20538149}
