...
head_complement_phrase *>
   (synsem:loc:cat:comps:append(Comps1,Comps2),                       % = Comps1 + Comps2
    ...
    non_head_dtr:synsem:NonHeadDtr).
...
head_adjunct_phrase *>
   (head_dtr:synsem:HD,
    non_head_dtr:synsem:loc:cat:(head:mod:HD,
                                 spr:[],
                                 comps:[])).
...
head_adjunct_phrase *>
   (synsem:loc:cont:ltop:LTop,
    non_head_dtr:synsem:loc:cont:ltop:LTop).
...
(head_adjunct_phrase,
 non_head_dtr:synsem:loc:cat:head:scopal:minus) *>
 (head_dtr:synsem:loc:cont:ltop:LTop,
  non_head_dtr:synsem:loc:cont:ltop:LTop).

(headed_phrase,
 non_head_dtr:synsem:loc:cat:head:spec:synsem) *>
 (head_dtr:synsem:Spec,
  non_head_dtr:synsem:loc:cat:head:spec:Spec).
...
head_adjunct_phrase *> (head_dtr:HD,
                           non_head_dtr:NHD,
                           ( non_head_dtr:synsem:loc:cat:head:pre_modifier:minus,
                               dtrs:[HD,NHD]
                           ; non_head_dtr:synsem:loc:cat:head:pre_modifier:plus,
                               dtrs:[NHD,HD]
                           )).
...
(headed_phrase,
 non_head_dtr:synsem:trace:extraction) *>
...
% Phrase maximal.
(head_complement_phrase,
 non_head_dtr:synsem:trace:extraction) *> synsem:max_:plus.
...
headed_phrase *>
  (synsem:nonloc:rel:(list_with_zero_or_one_element,
       ...
       non_head_dtr:synsem:nonloc:rel:Rel2).
