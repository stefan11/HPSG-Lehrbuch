...
\end{figure}
Die skopusaufgelösten MRSen entsprechen genau den beiden Lesarten aus (\ref{ex-Quantoren-Mitarbeiter-Tochter}).
...
\end{figure}
\itdopt{Punkte für Knoten hinzufügen, check, Y2 ist in der mittleren Abbildung zu weit vom Pfeil weg.}
...
einzigen Lexikoneintrags. (\mex{1}) zeigt den Lexikoneintrag für \stem{öffn}:\todostefan{check ob
