...
\citealt{RS2004a-u,IR2015a-u,Richter2016a-u,SailerRichter2021a-u}, \citealt[Abschnitt~6.2]{KR2024a}), die \emph{Minimal Recursion Semantics}\is{Minimal Recursion Semantics@\emph{Minimal Recursion Semantics} (MRS)}
...
Auf"|lagen konsultieren.%\todostefan{zitieren: \citep{Ginzburg2012a-u,LGC-Grammar-in-Dialog}}
...
Letzterem aus. Somit ergeben sich die folgenden Stelligkeiten:\todostefan{Jakob: Relationen als Beispiel
  angeben sterben(e,Aicke)}
\begin{itemize}
...
Strukturteilung nur syntaktische Information zu teilen.\todostefan{teilung teilen ändern?} Zum Beispiel möchte
...
und den Nicht"=Kopftöchtern ergibt, wenn es eine Kopftochter gibt. Andernfalls
...
bei intersektiver\todostefan{Begriff eingeführt?} Modifikation das Label von Kopf und Adjunkt identifiziert werden.
...
durch die rote Kante von y zu h4:tochter(x,y) erzwungen.\todostefan{S: Gepunktet und gestrichelt?
...
\itdopt{add something or delete}
...
\zs
Das Problem besteht nun darin, dass die Repräsentation für \emph{ihr Buch},
...
\citew[Kapitel~6]{ps2} und \citew{MuellerBinding}. Man könnte vorschlagen, die Bindungstheorie auf semantischen Repräsentationen
...
Analyse ist in Abbildung~\ref{Abbildung-DP-Possessivum} dargestellt. Die Kategorie von \emph{ihre}
...
wie \emph{ihren Kater}. Die Flexion entspricht jedoch klar der Flexion des Artikels
\emph{ein}. Würde man \emph{ihren} die Kategorie Possessivum geben oder irgendeine andere Kategorie,
