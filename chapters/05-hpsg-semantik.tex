...
\eal
\ex Ein Kind schläft.
\ex Es gibt mindestens ein x, für das gilt, dass es ein Kind ist und dass es schläft.
\ex \blau{$\exists$}x kind(x) \blau{$\wedge$} schlafen(x)
\zl
\eal
\label{ex-Das-Kind-schläft}
\ex Das Kind schläft.
\ex Es gibt ein einziges x, das Kind ist, und für dieses Kind gilt, dass es schläft.
...
\texttt{collect-rels} ist. Formal kann man das wie folgt aufschreiben:\todostefan{Boxen statt Variablennamen?}
\ea
...
wiederholt:\todostefan{Das war vorn anders.}
\eal
...
\noindent
Für das Adjektiv \emph{potentielle} ergibt sich:\todostefan{Erklären wie Index weitergegeben wird}
\eas
