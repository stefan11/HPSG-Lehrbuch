...
In der Lexikonregel in (\mex{0}) wird verlangt, dass das erste Element in der \subcatl des Verbs mit
...
\end{figure}
Der \subcatw des Eingabezeichens muss eine Liste sein, die mit zwei Nominalphrasen mit strukturellem Kasus
...
steht. Die Auf"|fassung, dass Morpheme Form"=Bedeutungs"=Paare sind, läßt sich für solche Fälle wohl nicht
aufrechterhalten.
