...
Bei Passivierung der Verben in (\mex{0}) ergeben sich die folgenden \argst"=Listen:
\ea
\begin{tabular}[t]{@{}l@{~}l@{~}l}
...
Realisierung durch ein PRO in Theorien wie Government \& Binding \citep[Abschnitt~2.4.1]{Chomsky81a}.
