...
ist klar, daß die Grammatik in (\mex{-1}) die am besten für ihren Zweck, nämlich die Beschreibung
...
Leider ist es so, daß in vielen Bereichen der Linguistik sehr schlampig mit Daten
...
eine Theorie zu widerlegen. Man kann \zb nicht sagen, daß eine bestimmte Theorie %der \emph{be}"=Derivation\is{Derivation}
...
darf. Man sagt, daß eine Theorie, die auch ungrammatische Sätze zuläßt, übergeneriert.\is{"Ubergenerierung} Im folgenden
...
siehe \citew{Mueller2003b}), dann muß es für diese Beispiele syntaktische Strukturen geben. Einen
...
daß es nicht möglich ist, weitere Beschränkungen zu formulieren, die bestimmte Strukturen/""Sätze ausschließen.
...
Bezug auf Weltwissen\is{Weltwissen} erklärt werden, das muß aber nicht unbedingt Gegenstand
...
vorwerfen, daß sie die Thema"=Verben nicht behandelt haben, aber er kann nicht behaupten, daß die Theorien
...
%% hinzuzufügen, die besagt, daß das Partizip eine Agens"=Rolle haben muß (Das wurde übrigens auch von
%% \citet[\page17]{Haider86} explizit vorgeschlagen.). Man braucht dann allerdings einen sehr weiten Agens"=Begriff.
%% Normalerweise wird \zb angenommen, daß der Sehende in (\mex{1}) ein Experiencer ist:
%% \eal
