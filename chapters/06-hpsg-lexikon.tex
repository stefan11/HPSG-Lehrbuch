...
Diese Funktion mag dem Leser obskur erscheinen, wir werden aber im Abschnitt~\ref{sec-morph-flex-anal}
...
folgenden sollen die jeweiligen Vorschläge diskutiert werden.\footnote{
  Entsprechende Vorschläge wurden auch in TAG\indextag \parencites{Candito96a}[\page 188]{CK2003a-u} und Simpler Syntax\is{Simpler Syntax} \citep[Abschnitt~6.3]{CJ2005a} gemacht. Diese können hier nicht diskutiert werden. Der interessierte Leser sei jedoch auf \citew{MuellerUnifying} und \citew{MWArgSt} verwiesen.
}
