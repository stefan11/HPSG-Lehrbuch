...
\ea
\label{relational-le}%
Alle relationalen Lexikonelemente (\type{relational-le}):\\
\avm{
[ cont & [ ltop & \1\\
           ind  & \2\\
           rels & < [\type{relation}\\
...
\noindent
Die Information kann man wie folgt aufteilen: Alle Verben teilen zusätzlich zu den Beschränkungen
für den Typ \type{relational-le} in (\ref{relational-le}) die Information
in (\mex{1}).
\ea
...
die türkischen Beispiele von \citet[\page 77]{Ozkaragoez86a} mit der von ihm verwendeten
Glossierung:
\largerpage
%% \eal
%% \ex
...
Flügel und können fliegen \citep[358--359]{RussellNorvig2003a-ed}. Diese Eigenschaften erbt der Subtyp \type{Spatz},
