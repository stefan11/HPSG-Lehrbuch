...
welchen Typ der Wert haben muss. Siehe hierzu auch Abschnitt~\ref{sec-modelle-theorien} und \citew{Richter2024a}.
...
Kapitel~\ref{Abschnitt-Valenzprinzip} besprochen (siehe Abbildung~\ref{fig-type-sign-Valenzprinzip}
...
\textcites{Mueller2006d,MuellerUnifying,MuellerLFGphrasal,MuellerLexikon,MuellerGT-Eng5,MuellerLFGTAG,MuellerTAGCxG}
...
\zl
Goldberg erklärt das so, dass die Verben in eine dreistellige Konstruktion hineingewürgt werden,
...
dreistelliges Verb in den entsprechenden Strukturen des Englischen benutzt werden. Ich habe schon im
...
der dem folgenden ähnelt:\footnote{
  ...
  \textsc{arg-liste} stehen, ist nicht festgelegt. Ohne weitere Spezifikationen ist über die \compsl
...
Linguist*innen unintuitiv finden. Lässt man solcherart Klassifikationen zu, stellt sich sofort die Frage,
