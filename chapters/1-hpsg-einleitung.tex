...
\end{tabular}
\z
Diese Grammatik lizenziert binär verzweigende Strukturen, wie die in Abbildung~\vref{fig-Aicke-dem-Affen-den-Stock-gibt-bin}.
...
\ex[*]{
Aicke den Affen den Stock gibt
}
\ex[*]{
...
\emph{gibt} verlangt ein Dativ"=Objekt. In (\mex{0}d) ist die Determinator"=Nomen"=Kongruenz
