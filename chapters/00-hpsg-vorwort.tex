...
alternativer Theorien ist für die fortgeschrittene Leser*in gedacht, 
...
verfügbar ist. Die \LaTeX-Quellen für die Folien befinden sich auf
\url{https://github.com/stefan11/HPSG-Folien-Deutsch/}. Der Quelltext für dieses Buch findet sich
unter dem im Impressum angegebenen Link.
Von der erstgenannten Seite gelangt man auch zu einer Seite, die computerverarbeitbare
Grammatiken enthält, die den jeweiligen Kapiteln in diesem Buch entsprechen. Eine virtuelle Maschine, die
alle zum Grammatikentwickeln benötigte Software und auch die Grammatiken enthält, ist unter
\url{https://hpsg.hu-berlin.de/Software/Grammix/} verfügbar. Alternativ gibt es
Installationsanweisungen für verschiedene Betriebssysteme. Der interessierten Leser*in
...
\url{http://www.taz.de/}, 24.02.2026.}, einer überregionalen
...
(siehe S.\,\pageref{bsp-den-groessten-Teil-der-Woche}).
...
\parencites[228]{MuellerPredication}{MuellerCopula}. Die entsprechenden Analysen haben sich im CoreGram"=Projekt\footnote{
...
\citep{MOe2011a,MuellerPredication,MuellerCopula,MOe2013a,MOeDanish}, Englisch\il{Englisch}
\citep{MuellerPredication,MuellerCopula,MOe2013a,MuellerLFGphrasal}, Jiddisch\il{Jiddisch} \citep{MOe2011a}, Spanisch\il{Spanisch}, Französisch\il{Französisch},
Maltesisch\il{Maltesisch} \citep{MuellerMalteseSketch},
Persisch\il{Persisch} \citep{MuellerPersian,MG2010a} und Mandarin Chinesisch\il{Mandarin Chinesisch} \citep{Lipenkova2009a,ML2009a,Lu2021a,LM2027a}.
}, bewährt. 

Wir haben uns entschlossen, die CD-Rom, die bisher mit dem Buch zusammen ausgeliefert wurde, nicht
mehr gemeinsam mit dem Buch zu vertreiben. Die Grammix-CD \citep{Mueller2007b} ist im Netz verfügbar\footnote{
...
Webseite verfügbaren Version noch nicht enthalten. Die Grammix"=CD
...
Arbeiten an der neuen Version der CD noch vor der Fertigstellung des Berliner Flughafens abschließen
...
überarbeitet und enthält jetzt auch eine Diskussion von Doppelpassivierungen\footnote{
  Anmerkung vom 24.02.2026: Bei den Konstruktionen handelt es sich um Interaktionen aus Passiv und
  Impersonalkonstruktion \citep{Blevins2003a}. Sie sind dennoch für vererbungsbasierte Analysen
  problematisch und werden im Abschnitt~\ref{sec-vererbung-koenig} jetzt nach aktuellem Kenntnisstand besprochen.
} im Türkischen\il{Türkisch} und
...
gleichzeitig auf meiner Webseite lassen kann. Ich habe Frau Narrs Kontonummer auf meiner Webseite
...
kostenlos zum Download auf meiner Webseite anbiete \ldots). 
...
Leser*innen für die Veröffentlichungen bezahlen müssen.%
% Stattdessen wird Language Science Press von über 100
%Universitäten weltweit finanziert.
} Seit 2014 gibt es Language Science Press. Ab diesem Zeitpunkt habe ich
auch meine Bücher dort veröffentlicht. 

Im April 2024 habe ich Frau Narr gefragt, ob ich die Rechte an diesem Buch zurückbekommen könnte,
und sie hat eingewilligt. Das Buch ist jetzt also wie fast alle meine Bücher frei und ich kann es
unter der CC-BY-Lizenz bei Language Science Press veröffentlichen. Ich habe ihr dieses Buch
gewidmet. Leider hat sie die Veröffentlichung nicht mehr erleben können.

Seit der letzten Auf\/lage 2013 hat sich einiges getan. Ich habe mich weiter mit sprachübergreifenden Fragestellungen
...
Kasus. Ich nehme, wie in neueren Arbeiten üblich, eine Argumentstruktur"=Liste (\argst) an, in der 
alle Argumente eines Kopfes enthalten sind. Die Argumente werden von dieser Repräsentation auf
...
entspricht der Normalstellung im Deutschen (bei den meisten Verben Nominativ, Dativ, Akkusativ) und der Stellung im
Englischen:
\eal
...
Das Semantik"=Kapitel wurde komplett überarbeitet. Statt der Situationssematik \citep*{BP83a,CMP90,Devlin92}, die in den ersten
drei Auf\/lagen des Buches verwendet wurde, gibt es im Kapitel~\ref{Kapitel-Semantik} nun eine
Einführung in die Minimal Recursion Semantics\indexmrs \citep*{CFPS2005a}.
...
Im Abschnitt~\ref{Abschnitt-phrasale-Valenz} gibt es als Teil des Kapitels über Valenz eine Diskussion darüber, ob lexikalisch kodierte Valenz oder phrasal
lizenzierte Ansätze adäquater sind. Die Diskussion über Alternativen im Lexikonkapitel wurde
ebenfalls ausgebaut und ein Abschnitt über Erzwingung (Coercion) hinzugefügt (Abschnitt~\ref{sec-Erzwingung}).

Ich habe das \textsc{dtrs}-Merkmal eingeführt, das wie bei \citet[29--30]{GSag2000a-u} alle Töchter
enthält. Dadurch wird es möglich, Prinzipien allgemeiner zu formulieren, und man kann
Generalisierungen bzgl.\ Verbzweitsätzen und Relativ- und Interrogativnebensätzen erfassen. Das
\textsc{non-head-dtrs}-Merkmal braucht man nicht mehr.

Die Satztypenanalyse in Abschnitt~\ref{sec-semantik-v1-v2} wurde komplett überarbeitet. Statt einer Relation wird jetzt
das \textsc{mode}"=Merkmal verwendet.

Der Abschnitt~\ref{sec-Crysmann} wurde gekürzt und der Abschnitt~\ref{sec-Wetta} über Wettas Analyse der scheinbar mehrfachen
Vorfeldbesetzung wurde neu aufgenommen. Der letztgenannte Abschnitt ist aus dem englischen Manuskript zur
deutschen Satzstruktur entstanden \citep{MuellerGS}, das schon längst veröffentlicht sein sollte.

Der Abschnitt~\ref{sec-np-kongruenz} zur Subjekt-Verb-Kongruenz wurde vereinfacht. Bisher wurde in
den Lexikoneinträgen immer noch die Semantik der Verben angegeben. Das ist jedoch gar nicht nötig,
denn der Index des Subjekts ist ja ohnehin in der \argstl enthalten und Beschränkungen für
Subjekt-Verb-Kongruenz werden auch in Bezug auf die \argstl formalisiert.

Im Kapitel~\ref{Kapitel-passiv} habe ich die Diskussion unakkusativischer Verben erweitert und um
eine Zusammenfassung ergänzt, so dass ganz klar ist, welche Tests anwendbar sind und welche nicht.
Die Partizipien I waren bisher nicht einheitlich analysierbar. Durch die Verwendung von \argst wurde das zum
ersten Mal möglich. Siehe Abschnitt~\ref{sec-adj-formation} zu den Details.
