...
\end{samepage}
%
Dieses Schema entspricht dem Kopf"=Komplement"=Schema, das wir bis zum Kapitel~\ref{Kapitel-Konstituentenreihenfolge}
benutzt haben, bzw.\ der angepassten Version auf S.\,\pageref{schema-head-arg}.
...
\NOTE{WS: Die Erklärung, warum (18) nicht geht, verstehe ich nicht. \emph{wird} kann doch keine anderen Argumente als \emph{lachen} haben, die müsste es ja von lachen übernehmen und da kommt es ja nicht ran.}
\ea[*]{
dass lachen er wird
}
\z
