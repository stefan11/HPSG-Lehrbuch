...
bzw.\ Ungunsten (\mex{1}b) etwas geschieht (\textit{dativus commodi}\is{Dativ!commodi@\emph{commodi}} und \textit{dativus incommodi}\is{Dativ!incommodi@\textit{incommodi}})\footnote{\label{fn-dativ-commodi}%
...
%% \z
%% So nimmt \zb \citet[\page 14]{Rothstein} an, daß \emph{him a fool} einen
%% sogenannten \emph{Small Clause}\is{Small Clause@\textit{Small Clause}} bildet.
