...
\begin{forest}
type hierarchy, 
%for tree={where n children=0{tier=max}{}} % put all maximal types at one line, except subord
%for level=3{l*=1.5}, % increases the distance to the third level (the maximal types) by a factor of 1.5
