...
Im\is{Extraktion|(}\is{nichtlokale Abhängigkeit|(}\is{Konstitutentenstellung|(} Deutschen stehen die Konstituenten in
...
\end{comment}
\is{Extraktion|)}\is{nichtlokale Abhängigkeit|)}\is{Konstitutentenstellung|)}
