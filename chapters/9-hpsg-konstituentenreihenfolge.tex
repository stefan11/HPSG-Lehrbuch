...
\zl
Die Analyse von (\mex{0}a) zeigt Abbildung~\vref{abb-jeder-das-buch-kennt}
und die von (\mex{0}b) 
Abbildung~\ref{abb-das-buch-jeder-kennt}.%
\begin{figure}[htb]
...
%\psgrid
\end{pspicture}}%
\caption{\label{abb-jeder-das-buch-kennt}Analyse für \emph{jeder das Buch kennt}}
\end{figure}%
\begin{figure}[htb]
\psset{xunit=1cm,yunit=8mm}%
\centerline{%
...
%\psgrid
\end{pspicture}}%
\caption{\label{abb-das-buch-jeder-kennt}Analyse für \emph{das Buch jeder kennt}}
\end{figure}
Die beiden Analysen unterscheiden sich einzig und allein darin, welches Element der \subcatl
zuerst abgebunden wird: In Abbildung~\ref{abb-jeder-das-buch-kennt} wird zuerst das Akkusativobjekt
mit dem Verb kombiniert und in Abbildung~\ref{abb-das-buch-jeder-kennt} zuerst das Subjekt. In der
Analyse in Abbildung~\ref{abb-jeder-das-buch-kennt} ist bei der Kombination von \emph{das Buch} und
...
Abbildung~\ref{abb-jeder-das-buch-kennt}).  Das Nominativargument wird im zweiten Schritt gesättigt:
...
gesättigte Phrase. In der Analyse in Abbildung~\ref{abb-das-buch-jeder-kennt} ist die \ibox{3}
...
Die%\enlargethispage{\baselineskip} 
Konsequenz der Linearisierungsregel in (\mex{-1}) ist, daß jetzt nur noch die beiden 
...
\centering
\begin{tabular}{cccc}
\mc{2}{@{}c@{}}{\rnode{n4}{N[\begin{tabular}[t]{@{}l@{}}
        \spr \sliste{  },\\
        \subcat \sliste{  } ]\\
      \end{tabular}}}\\
\\[3ex]
\rnode{det}{\ibox{1} Det} & \mc{3}{@{}c@{}}{\rnode{n3}{N[\begin{tabular}[t]{@{}l@{}}
        \spr \sliste{ \ibox{1} },\\
        \subcat \sliste{  } ]\\
      \end{tabular}}}\\
\\[3ex]
    & \mc{2}{@{}c@{}}{\rnode{n2}{N[\begin{tabular}[t]{@{}l@{}}
        \spr \sliste{ \ibox{1} },\\
        \subcat \sliste{ \ibox{2} } ]\\
      \end{tabular}}}                             & \rnode{pp}{\ibox{2} PP[durch]}\\
\\[3ex]
    & \rnode{n1}{N[\begin{tabular}[t]{@{}l@{}}
        \spr \sliste{ \ibox{1} },\\
        \subcat \sliste{ \ibox{2}, \ibox{3} } ]\\
      \end{tabular}} & \rnode{np}{\ibox{3} NP[\type{gen}]}  \\
\\[3ex]
\rnode{die}{die} & \rnode{zerstoerung}{Zerstörung} & d\rnode{ds}{er Stad}t & d\rnode{dds}{urch die Soldate}n\\
\end{tabular}
\ncline{n4}{det}\ncline{n4}{n3}%
\ncline{n3}{n2}\ncline{n3}{pp}%
\ncline{n2}{n1}\ncline{n2}{np}%
\ncline{det}{die}\ncline{n1}{zerstoerung}%
\ncline{np}{ds}\ncline{pp}{dds}%
...
\begin{figure}[htbp]
\resizebox{\linewidth}{!}{\begin{pspicture}(0.6,-2)(17.2,4.4)
%\psgrid
...
\rput[B](9,0){\rnode{hnars}{\type{head"=non"=argument"=phrase}}}
%\rput[B](15,0){\rnode{hnfs}{\type{head"=non"=filler"=phrase}}}
\rput[B](15,0){\rnode{hnss}{\type{head"=non"=specifier"=phrase}}}
\rput[B](3,-2){\rnode{has}{\textit{head"=adjunct"=phrase}}}
\rput[B](9,-2){\rnode{hars}{\textit{head"=argument"=phrase}}}
%\rput[B](15,-2){\rnode{hfs}{\textit{head-filler"=phrase}}}
\rput[B](15,-2){\rnode{hss}{\textit{head"=specifier"=phrase}}}
%
\psset{angleA=-90,angleB=90,arm=0pt}
%
\ncdiag{sign}{word}\ncdiag{sign}{phrase}
...
Zur Verdeutlichung soll die Analyse des Satzes in (\ref{bsp-kennt-er-das-buch}) erklärt werden:
\eal
\ex daß er das Buch kennt\label{bsp-dass-er-das-buch-kennt}
\ex Kennt$_i$ er das Buch \_$_i$?\label{bsp-kennt-er-das-buch}
\zl
...
Die syntaktischen Aspekte der Analyse von (\ref{bsp-kennt-er-das-buch}) sind in Abbildung~\vref{verb-movement-syn-simple}
dargestellt. 
\begin{figure}[htbp]
...
\multicolumn{2}{@{}c@{}}{\rnode{1}{V[\subcat \eliste]}}\\
\\*[3ex]
\rnode{2}{V} & \multicolumn{2}{@{}c@{}}{\rnode{3}{V[\subcat \eliste]}}\\
\\*[4ex]
                                     & \rnode{4}{\ibox{3} NP[\textit{nom\/}]}& \multicolumn{2}{@{}l@{}}{\rnode{5}{V[\subcat \sliste{ \ibox{3} }]}}\\
\\*[4ex]
                                   &                                   & \rnode{6}{\ibox{4} NP[\textit{acc}]} & \rnode{7}{V[\subcat \sliste{ \ibox{3}, \ibox{4} }]} \\
\\*[3ex]
...
\caption{\label{verb-movement-syn-simple}Analyse von \emph{Kennt er das Buch?}}
\end{figure}
Die Kombination der Spur mit \emph{das Buch} und \emph{er} folgt den Regeln und Prinzipien, die
...
%
Die Analyse von (\ref{bsp-kennt-er-das-buch}) zeigt Abbildung~\vref{verb-movement-syn}.
\begin{figure}[htb]
%\centerline{\mbox{\includegraphics[width=0.9\textwidth]{netter-verb-movement}}}
\centerline{%\resizebox{0.9\textwidth}{!}{%
%\nodemargin5pt
...
\\*[4ex]
\rnode{2}{V[\textsc{subcat} \sliste{ \ibox{1} }]} & \multicolumn{3}{@{}l@{}}{\rnode{3}{\ibox{1} V[\begin{tabular}[t]{@{}l}
...
\rnode{2b}{V[\textsc{subcat} \ibox{2} ]} & \rnode{4}{\ibox{3} NP[\textit{nom\/}]}& \multicolumn{2}{@{}l@{}}{\rnode{5}{V[\begin{tabular}[t]{@{}l}
                                                                                                       \textsc{dsl$|$cat$|$subcat} \ibox{2},\\
                                                                                                       \textsc{subcat} \sliste{ \ibox{3} }]\\
                                                                                                       \end{tabular}}
                                                                                           }\\
\\*[4ex]
                                   &                                   & \rnode{6}{\ibox{4} NP[\textit{acc}]} & \rnode{7}{V[\begin{tabular}[t]{@{}l}
                                                                                                 \textsc{dsl$|$cat$|$subcat} \ibox{2},\\
...
\caption{\label{verb-movement-syn}Veranschaulichung der Analyse von \emph{Kennt er das Buch?}}
\end{figure}
...
% \cont \ibox{1}]
% \end{tabular}} & \multicolumn{3}{@{}l@{}}{\rnode{3}{\ibox{2} V[\begin{tabular}[t]{@{}l@{}}
%                                                                     \textsc{dsl$|$cat$|$subcat} \ibox{3},\\
%                                                                     \textsc{subcat} \sliste{ }\\
% \cont \ibox{1}]
%                                                                     \end{tabular}}
%                                                        }\\
% \\
%                                    & \hspace{0mm}C                   & \hspace{15mm}H\\*[3ex]
%                                    & \rnode{4}{\ibox{4} NP[\textit{nom\/}]}& \multicolumn{2}{@{}l@{}}{\rnode{5}{V[\begin{tabular}[t]{@{}l}
%                                                                                                        \textsc{dsl$|$cat$|$subcat} \ibox{3},\\
...
% \\
%                                    &                                   & C                                & \hspace{-5mm}H\\*[3ex]
%                                    &                                   & \rnode{6}{\ibox{5} NP[\textit{acc}]} & \rnode{7}{V[\begin{tabular}[t]{@{}l}
%                                                                                                  \textsc{dsl$|$cat$|$subcat} \ibox{3},\\
%                                                                                                  \textsc{subcat} \ibox{4} \sliste{ \ibox{5}, \ibox{4} }\\
% \cont \ibox{1}] \\
%                                                                                                  \end{tabular}}\\
% \\*[3ex]
% \rnode{8}{kennt}                     & \rnode{9}{er}                  & d\rnode{10}{as Buc}h & \rnode{11}{$-$}\\
...
% \ncline{7}{11}%
% }%}
% \caption{\label{verb-movement-syn}Analyse von \emph{Kennt er das Buch?}}
% \end{figure}
\begin{figure}[htb]
%\centerline{\mbox{\includegraphics[width=0.9\textwidth]{netter-verb-movement}}}
\centerline{%\resizebox{0.9\textwidth}{!}{%
...
\end{tabular}} & \multicolumn{3}{@{}l@{}}{\rnode{3}{V[\begin{tabular}[t]{@{}l@{}}
                                                                    \textsc{dsl$|$cont} \ibox{1},\\
                                                                    \cont \ibox{2}]
                                                                    \end{tabular}}
                                                       }\\
\\
\hspace{8ex}V1-LR\\*[3ex]
\rnode{2b}{V[\cont \ibox{1}  kennen'(er,buch)]} & \rnode{4}{NP[\textit{nom\/}]}& \multicolumn{2}{@{}l@{}}{\rnode{5}{V[\begin{tabular}[t]{@{}l}
                                                                                                       \textsc{dsl$|$cont} \ibox{1},\\
                                                                                                       \cont \ibox{2}]\\
                                                                                                       \end{tabular}}
                                                                                           }\\
\\*[4ex]
                                   &                                   & \rnode{6}{NP[\textit{acc}]} & \rnode{7}{V[\begin{tabular}[t]{@{}l}
                                                                                                 \textsc{dsl$|$cont} \ibox{1},\\
                                                                                                  \cont \ibox{2} = \ibox{1}] \\
                                                                                                 \end{tabular}}\\
\\*[3ex]
...
\caption{\label{verb-movement-sem}Veranschaulichung der Analyse von \emph{Kennt er das Buch?}}
\end{figure}
...
\\*[4ex]
                                   &                                  &                          & \rnode{8}{Adv[\begin{tabular}[t]{@{}l@{}}
                                                                             \textsc{mod} \ibox{3} [\textsc{loc}$|$\cont \ibox{1}],\\
                                                                             \cont \ibox{2} $\neg$ \ibox{1}]
...
\caption{\label{verb-movement-adjunkt-sem}Veranschaulichung der Analyse von \emph{Kennt er das Buch nicht?}}
\end{figure}
...
\emph{er} und \emph{das Buch} gesättigt werden. Der \textsc{dsl$|$cont}"=Wert der verbalen Projektion
...
daß bei einer Analyse des Satzes (\ref{bsp-kennt-er-das-buch}) der \localw der Verbspur genau dem entspricht, was in
...
\\[3ex]
\rnode{2}{\ibox{1} NP[\textit{nom\/}]} & \rnode{4}{\ibox{3} NP[\textit{dat\/}]}     & \rnode{6}{\ibox{2} NP[\textit{acc\/}]} & \rnode{7}{V[\textit{fin\/}, \textsc{subcat} \sliste{ \ibox{1}, \ibox{2}, \ibox{3} }] }\\
\\
\\*[5ex]
...
\ncline{4}{9}%
\ncline{6}{10}}%
\caption{\label{abb-uszkoreit-pollard}Analyse von \emph{der Mann der Frau das Buch gibt} mit flachen Strukturen}
\end{figure}
...
bzw.\ in der \href{http://www.cl.uni-bremen.de/~stefan/Pub/mehr-vf-ds.html}{im WWW zugänglichen Datensammlung}\footnote{
  \url{http://www.cl.uni-bremen.de/~stefan/Pub/mehr-vf-ds.html}.%
}.
...
\\*[4ex]
\psovalbox{\rnode{2}{\ibox{1} NP[\textit{nom\/}]}} & \multicolumn{2}{@{}l@{}}{\rnode{3}{V[\begin{tabular}[t]{@{}l}
                                                                    \textit{fin\/}, \textsc{subcat} \sliste{ \ibox{1} }]\\
                                                                    \end{tabular}}
                                                       }\\
\\*[4ex]
& \psovalbox{\rnode{4}{\ibox{2} NP[\textit{acc\/}]}} & \multicolumn{2}{@{}l@{}}{\rnode{5}{V[\begin{tabular}[t]{@{}l}
                                                                    \textit{fin\/}, \textsc{subcat} \sliste{ \ibox{1}, \ibox{2} }]\\
                                                                    \end{tabular}}
                                                       }\\
\\*[4ex]
&                                   & \psovalbox{\rnode{6}{\ibox{3} NP[\textit{dat\/}]}}& \psovalbox{\rnode{7}{V[\begin{tabular}[t]{@{}l}
                                                                                   \textit{fin\/}, \textsc{subcat} \sliste{ \ibox{1}, \ibox{2}, \ibox{3} }]\\
%                                                                                   \textsc{vcomp} \sliste{  }, \\
                                                                                   \end{tabular}}}\\
\\*[6ex]
...
\multicolumn{3}{@{}l@{}}{\rnode{1}{V[\begin{tabular}[t]{@{}l}
  \textit{fin\/}, \textsc{subcat} \sliste{ },\\
                                                                                   \textsc{dom} \phonliste{ der Mann, der Frau, das Buch, gibt }]\\
  \end{tabular}}
}\\
\\*[4ex]
\rnode{2}{\ibox{1} NP[\textit{nom\/}]} & \multicolumn{2}{@{}l@{}}{\rnode{3}{V[\begin{tabular}[t]{@{}l}
                                                                    \textit{fin\/}, \textsc{subcat} \sliste{ \ibox{1} },\\
                                                                                   \textsc{dom} \phonliste{ der Frau, das Buch, gibt }]\\
                                                                    \end{tabular}}
                                                       }\\
\\*[4ex]
& \rnode{4}{\ibox{2} NP[\textit{acc\/}]} & \multicolumn{2}{@{}l@{}}{\rnode{5}{V[\begin{tabular}[t]{@{}l}
...
\rnode{2}{\ibox{1} NP[\textit{nom\/}]} & \multicolumn{2}{@{}l@{}}{\rnode{3}{V[\begin{tabular}[t]{@{}l}
                                                                    \textit{fin\/}, \textsc{subcat} \sliste{ \ibox{1} },\\
                                                                                   \textsc{dom} \phonliste{ gibt, das Buch, der Frau }]\\
                                                                    \end{tabular}}
                                                       }\\
\\*[4ex]
& \rnode{4}{\ibox{2} NP[\textit{acc\/}]} & \multicolumn{2}{@{}l@{}}{\rnode{5}{V[\begin{tabular}[t]{@{}l}
...
\multicolumn{2}{@{}l}{\rnode{1}{V[\begin{tabular}[t]{@{}l}
  \textit{fin}, \textsc{subcat} \liste{ },\\
  \textsc{dom} \phonliste{ \rnode{1bot}{gibt}, der Mann, das Buch, der Frau }]\\
  \end{tabular}}}\\
\\*[4ex]
\rnode{3}{V[\begin{tabular}[t]{@{}l}
         \textit{fin}, \textsc{subc\rnode{3top}{\rule{0cm}{1.5ex}}at} \liste{ \ibox{1} },\\
         \textsc{dom} \phonliste{ \rnode{3bot}{gibt}, das Buch, der Frau }]\\
         \end{tabular}}                                     & \rnode{2aux}{} \\
\\*[4ex]
\rnode{5}{V[\begin{tabular}[t]{@{}l}
         \textit{fin}, \textsc{subc\rnode{5top}{\rule{0cm}{1.5ex}}at} \liste{ \ibox{1}, \ibox{2} },\\
         \textsc{dom} \phonliste{ \rnode{5bot}{gibt}, der Frau }]\\
         \end{tabular}} & & \rnode{4aux}{}\\
\\*[4ex]
\rnode{7}{V[\begin{tabular}[t]{@{}l}
            \textit{fin}, \textsc{subc\rnode{7top}{\rule{0cm}{1.5ex}}at} \liste{ \ibox{1}, \ibox{2}, \ibox{3} },\\
            \textsc{dom} \phonliste{ \rnode{7bot}{gibt} }]\\
%            \textsc{vcomp} \liste{  }, \\
