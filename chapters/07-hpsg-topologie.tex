...
findet man in \citew{Reis80a}, \citew{Hoehle83a,Hoehle86}, \citew{Askedal86} und \citew{Woellstein2010a-u}.
...
Interrogativ- bzw.\ Relativphrasen ebenfalls zum Vorfeld zu zählen. Siehe
Abschnitt~\ref{sec-syntax-rs} und~\ref{sec-Generalisierung-Satztypen} für eine
entsprechende Analyse.\is{Interrogativsatz|)}\is{Relativsatz|)}
...
\eal
\ex {}[Über dieses Thema]$_i$ habe ich sie gebeten, [[einen Vortrag \_$_i$] zu halten].
\ex das Thema, [über das]$_i$ ich sie gebeten habe, [[einen Vortrag \_$_i$] zu halten]
\zl
...
einheitlich beschreiben möchte, muss man annehmen, dass sich auch im Standarddeutschen die Relativ-
bzw.\ Interrogativphrasen im Vorfeld befinden.\is{Interrogativsatz|)}\is{Relativsatz|)} 
...
% unklar, warum der skip gebraucht wird. bug 06.03.2026
\medskip
\ea
...
\citet{Woellstein2010a-u} gibt in einem kleinen Lehrbuch einen Überblick zu verschiedenen Auf"|fassungen zu topologischen
Feldern.
...
ersten Mal einer breiten Öffentlichkeit zugänglich gemacht \citep{Hoehle83a}. 
}