...
%\resizebox{\linewidth}{!}{%
\ms{
\ldots & \ms{ cat$|$arg-st  \sliste{ NP[\type{str}]\ind{1}  } $\oplus$ \ibox{2} $\oplus$ \nliste{
...
\ms{ \ldots & \ms{ cat$|$arg-st \sliste{ NP[\type{str}]\ind{1} } $\oplus$ \ibox{2} $\oplus$ \ibox{3} $\oplus$ \sliste{ \textrm{V[}%
