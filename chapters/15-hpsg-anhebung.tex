...
"`dritte Konstruktion"'\is{dritte Konstruktion|(}\footnote{
	Die Bezeichnung \emph{dritte Konstruktion} stammt von \citet*{dBR89}.
...
\zl
\citet[295]{Pollard90a} und \textcites[268]{Kiss92}[Abschnitt~3.1.1]{Kiss95a} haben deshalb vorgeschlagen, das Subjekt infiniter
...
(zu Lexikonregeln siehe Abschnitt~\ref{sec-lr}). Beide Formen haben dieselbe \argstl wie der
...
\subjl (zu den Details siehe Abschnitt~\ref{sec-analysis-da-modal-inf}).
\is{Merkmal!\textsc{subj}|)}
...
Kopf"=Komplement"=Schemas (siehe S.\,\pageref{schema-bin}) sagt nichts über den phrasalen Status des Arguments aus: Sowohl gesättigte
...
\ldots & \ms{ cat & \ms{ arg-st & \begin{tabular}[t]{@{}l@{}}
                                  ...
                                  \nliste{ V[}\type{inf}, \textsc{subj} \sliste{NP[\type{str}]\ind{1}}, \textsc{comps}~\ibox{2}, \ltop \ibox{3}]
                                  \end{tabular}}\\
