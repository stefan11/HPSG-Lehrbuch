...
\ldots & \ms{ cat & \ms{ arg-st & \begin{tabular}[t]{@{}l@{}}
                                  \sliste{ NP[\type{str}]\ind{1}  } $\oplus$ \ibox{2} $\oplus$ \\
                                  \nliste{ \textrm{V[}\type{inf}, \textsc{subj} \sliste{NP[\type{str}]\ind{1}}, \textsc{comps}~\ibox{2}, \ltop \ibox{3}]  }
                                  \end{tabular}}\\
...
\ms{ \ldots & \ms{ cat & \ms{ arg-st & \begin{tabular}[t]{@{}l@{}}
                                     \sliste{ NP[\type{str}]\ind{1} } $\oplus$ \ibox{2} $\oplus$ \ibox{3} $\oplus$\\
                                     \sliste{ \textrm{V[}\type{bse}, \textsc{lex}+, \textsc{subj}~\ibox{2}, \textsc{comps}~\ibox{3}, \ltop \ibox{4}] }
                                     \end{tabular}}\\[2mm]
...
\ldots & \ms{ cat & \ms{% head   & verb \\
           arg-st & \begin{tabular}[t]{@{}l@{}}
                    \sliste{ NP[\str]\ind{1}, NP[\type{ldat}]\ind{2} } $\oplus$ \ibox{3} $\oplus$\\
