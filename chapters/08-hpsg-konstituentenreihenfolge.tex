...
Das\is{Konstitutentenstellung|(} Deutsche ist eine Sprache mit relativ freier Konstituentenstellung.
...
Man kann das Problem entschärfen, indem man auch die Kopfmerkmale einzeln teilt. (\mex{1}) zeigt die
entsprechend angepasste Spur:
\eas
...
bildet. Bei Linearisierungsansätzen gibt es dagegen keine einfache Möglichkeit, 
die Konstituenten im Vorfeld zu einer Konstituente zusammenzufassen.\todostefan{Wetta} Man
könnte natürlich -- wie in \citews{Mueller2002f}[121]{Mueller2002c} vorgeschlagen 
...
\emph{Feuer} realisiert wird, ist dabei unerheblich. Siehe Abschnitt~\ref{sec-pvp}.\is{Vorfeldbesetzung!scheinbar mehrfache|)}
...
\mbox{}\citet[27]{Frey2004a}\is{Topik|(}\is{Fokus|(}\is{Informationsstruktur|(} nimmt eine KontrP (Kontrastphrase) und 
...
%
\is{Freezing@\emph{Freezing}|)}\is{Konstitutentenstellung|)}
