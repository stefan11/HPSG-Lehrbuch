...
\zs
Durch die Teilung der Werte innerhalb des \dslwes mit denen der Verbspur in (\mex{0}) ist die Information
...
Komplement eine Verbalprojektion sein muss (\head \type{verb}). Das ist aber nicht nötig, denn bei
den bisher verwendeten Verbspuren muss die Wortart der Spur ohnehin \type{verb} sein. Daraus, dass
es einen gefüllten \dslw gibt, folgt die Wortart. Auch bei der verallgemeinerten Version der
Kopfspur (siehe (\ref{le-verbspur}) auf S.\,\pageref{le-verbspur}) ist die Information darüber, dass eine Verbspur projiziert wird, vorhanden. Das liegt
daran, dass der \dslw im selegierten Satz die Information darüber enthält, dass die Spur den \dslw \ibox{1} (finites Verb in Letztstellung) haben
muss. Daraus ergibt sich für die Spur, dass sie ein Verb sein muss, da ja in der Spur der \dslw und der
\localw identifiziert werden. Somit kommen als Komplemente des Verberstverbs nur
...
\zs
\itdopt{Das ist falsch wegen mehrfacher Vorfeldbesetzung einfach alten Text nehmen, dann diskutieren}
...
In \citew[Abschnitt~11.5.2]{Mueller99a} und \citew{Mueller2004b} habe ich darauf hingewiesen,
