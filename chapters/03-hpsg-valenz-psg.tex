...
Rolle, wie in den folgenden Kapiteln erklärt werden wird. Bei (\ref{ex-Vorfeldellipse}) handelt es sich um einen Satz mit Vorfeldellipse \citep{Fries88b}. Dieser Satz könnte die
