...
von Köpfen gibt es ein listenwertiges \textsc{comps}"=Merkmal, das Beschreibungen
...
\begin{tabular}[t]{@{}lll}
      ...
      \end{tabular}
\z
\comps ist die Abkürzung für \textsc{compsegorization}. Man spricht auch davon,
...
gebildet werden. Im Englischen gibt es auch die Verwendung \emph{X compsegorizes for Y}, was soviel wie
...
(\comps)\isfeat{comps} kann wie folgt dargestellt werden:
\ea
\label{le-gibt-1}
