...
lassen.\footnote{%
  ...
  Adjunkte den Kopf, den sie modifizieren, selegieren. \Citet{NB94} haben eine Analyse
  vorgeschlagen, in der Adjunkte per Lexikonregeln in Valenzmerkmale aufgenommen werden. Auf diese
  Analyse komme ich im Abschnitt~\ref{sec-lr-for-transp-pvs} zurück. Ich übernehme sie für bestimmte
  Partikelverbkonstruktionen. \citet*[42]{BMS2001a} schlagen ebenfalls vor, einige Adjunkte als
  valenzabhängige Elemente zu behandeln.%
...
dem wir uns mit Kopfmerkmalen und dem Kopfmerkmalsprinzip (siehe S.\,\pageref{prinzip-hfp})
...
Im folgenden Abschnitt bespreche ich ein morphologisches Problem, auf das ich schon in
...
Die \bard entspricht der Passivierung mit einer zusätzlichen Modalbedeutung \citep{Gelhaus77}:
\eal
...
\zl
Also: Es gibt keine semantischen Gründe, die gegen die Bildung von \noword{helfbar}
...
Rolle, wie in den folgenden Kapiteln erklärt werden wird. Bei (\mex{1}e) handelt es sich um einen Satz mit Vorfeldellipse \citep{Fries88b}. Dieser Satz könnte die
...
Es bleibt dann nur, dass man sagt: Wenn \emph{geben} mit zwei Argumenten, \dash ohne Subjekt ist
auch eine Argumentstrukturkonstruktion. Leider ist die Vorfeldellipse nicht auf Subjekte
beschränkt. Auch Akkusativobjekte können weggelassen werden:
\eal
...
Argumenten, die prinzipiell zu einer Argumentstrukturkonstruktion gehören, sondern die potentielle
Realisierung ausschlaggebend sind. 

Subjekte werden nie in Kontrollkonstruktionen wie (\mex{1}) ausgedrückt \citep[Abschnitt~4]{Mueller2007d}:
\ea
...
Im Abschnitt~\ref{Abschnitt-Lexikonregeln} stelle ich Lexikonregeln vor, mit denen man aus
...
\parencites[vergleiche z.\,B.][]{Haider82,Grewendorf83a,Kratzer84a,Webelhuth85a,%
Sternefeld85b,%
Scherpenisse86a,%S. 31, Kapitel~4
Fanselow87a,Grewendorf88a,Duerscheid89a,Webelhuth90,Oppenrieder91a,Wilder92a,Haider93a,Grewendorf93,%
Frey93a,%S.30
%Duerscheid89a:60
Lenerz94a,%
Meinunger2000a%S. 30
