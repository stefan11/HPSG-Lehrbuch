...
passen. Nerbonne und Johnson haben das Problem gelöst, aber die Lösung bestand darin, dass sie die
lexikalische Repräsentation von Valenz aus der Kategorialgrammatik in GPSG nachgebaut haben.
...
werden können. Zum Beispiel haben ich in (\ref{le-gibt-1}) den Lexikoneintrag für \emph{gibt} angegeben. Mit
...
Charakteristische der Konstruktion scheint vielmehr zu sein, dass diese Elementen überhaupt gemeinsam miteinander vorkommen. Das würde in einem Ansatz
