...
%                             subj  & \eliste \\
           ...
           subcat & \liste{NP[\type{str}]$_{\ibox{1}~2, sg}$} \\
         }\\
cont & \ms[present]{
...
[{V[\cont \ibox{1}]}
   ...
   [{V[\subcat \sliste{ \ldots, \ibox{2} }, \cont \ibox{1} \emph{present}\iboxb{5}]}, l sep+=\baselineskip
%Flexions-LR
      [V\feattab{
...
[{N[\cont \ibox{1}]}
  ...
  [{N[\subcat \sliste{ \ldots, \ibox{2} }, \cont \ibox{1} \ldots{}
...
\begin{forest}
sm edges
[{V[\subcat \ibox{1} $\oplus$ \ibox{2} $\oplus$ \ibox{3} $\oplus$ \nliste{ Part[\subj \ibox{2}, \subcat \ibox{3}] }]}, l sep+=\baselineskip
  [{V[\subcat \ibox{1} \sliste{ NP[\str] }]}, edge label={node[midway,right]{PV-LR}} 
    [fahr]]]
\end{forest}
...
\begin{forest}
sm edges
[{Adj[\subj \sliste{ \ibox{4} }, \subcat \ibox{5} $\oplus$ \nliste{ Part[\subj \ibox{2}, \subcat \ibox{3}] }]}, l sep+=\baselineskip
...
\begin{forest}
sm edges
[{Adj[\subj \sliste{ \ibox{4} }, \subcat \ibox{5} \eliste]}
   [\ibox{6} Part\feattab{
                 \subj \ibox{2} \sliste{ NP[\str] },\\
                 \subcat \ibox{3} \eliste } [an]]
   [{Adj[\subj \sliste{ \ibox{4} }, \subcat \ibox{5} $\oplus$ \sliste{ \ibox{6} }]}, l sep+=\baselineskip
%& \hspace{19ex}\bard LR\\[4ex]
      [{V[\begin{tabular}[t]{@{}l@{}}
                \subcat \ibox{1} $\oplus$ \ibox{2} $\oplus$ \ibox{3} $\oplus$
                \nliste{ Part[\subj \ibox{2}, \subcat \ibox{3}] }]\\
...
[{Adj[\cont \ibox{1}]}
   ...
   [{Adj[\subcat \sliste{ \ibox{2} }, \cont \ibox{1} \emph{modal-op}(\,\ibox{5}\,)]}, l sep+=\baselineskip
%& \hspace{19ex}\bard LR\\[4ex]
      [V\feattab{
        \subcat \nliste{ \ldots, \ibox{2} Part[\textsc{mod} \ibox{3}, \cont \ibox{5}] },\\
