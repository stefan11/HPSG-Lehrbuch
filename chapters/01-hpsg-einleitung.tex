...
dass das Nomen der Kopf ist (\citealp[\page 49]{ps2}; \citealp{Demske2001a}).
...
In (\mex{0}) sind wir von einer Folge von Wörtern ausgegangen und haben gezeigt, dass wir die Regeln
...
Im folgenden soll überlegt werden, wie man die Grammatik verändern muss, damit die Sätze in (\mex{0})
