...
warum es sinnvoll ist, die Erkenntnisse zu formalisieren (Abschnitt~\ref{sec-formal}).\footnote{
  Dieses Kapitel bildete die Grundlage der ersten beiden Kapitel meines Grammatiktheoriebuches
  \citep{MuellerGTBuch2}. Den Abschnitt über Interrogativnebensätze und Relativsätze und
  topologische Felder, hatte ich zuerst in die Grammatiktheorie integriert und habe ihn nun für die
  vierte Auflage dieses Buches auch hier in den Abschnitt~\ref{sec-Topologische-Felder-Zuordnung} integriert.
}
...
der Kopf ist
\parencites[\page 6]{Ajdukiewicz35a-u}{VH77a-u}[Abschnitt~6]{Brame81a-u}{Brame82a}[\page 90--92]{Hudson84a-u}{Hellan86a,Abney87a,Netter94,Netter98a}, als auch solche, die annehmen,
...
so dass man erklären kann, warum bestimmte Verletzungen zu stärkeren Abweichungen führen als andere.\todostefan{Quelle}
