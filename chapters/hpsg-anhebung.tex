...
%% \footnote{
%%         Zur Grenzpause siehe auch \citew[\page 33]{Drach37}.\iaf{Drach}
%% }
...
\zl
(\mex{0}b) unterscheidet sich von (\mex{-1}b) dadurch, daß es sich um
...
wenn sie zu zwei verschiedenen Kohärenzfeldern gehören.\footnote{
        ...
        $F^3$ = \emph{ihr treu}.
        \ea
        daß er ihr immer treu\iwf{treu} sein wollte
        \z
...
\z
Bei infiniten Kohärenzfeldern muß es nicht unbedingt ein Restfeld geben. (\mex{1}) ist ein Beispiel
...
können\NOTE{vielleicht Müller99a zitieren}), daß Verben links von den sie einbettenden Verben stehen. Da \emph{zu kommen} in (\mex{0})
...
das Buch nicht zu lesen (\mex{1}a), oder daß es Karl gestattet ist, nicht zu versuchen, das Buch zu lesen (\mex{1}b),
oder daß es Karl nicht gestattet ist zu versuchen, das Buch zu lesen (\mex{1}c).
\eal
\label{la}
...
\zl
In (\mex{1}) und (\mex{2}) liegen jeweils zwei Kohärenzfelder vor, so daß
...
weil $\overbrace{ \underbrace{\rule[-0.5ex]{0cm}{2.5ex}\mbox{es ihm jemand} }_{R}~
        ...
        Siehe Haider, \citeyear[\page 110]{Haider86c}; Haider, \citeyear[\page 128]{Haider90b}\iafdata{Haider}.
}
\z
...
wie in (\mex{0}) nicht unbedingt adjazent zu seinem logischen Kopf sein muß.
...
\zl
In jedem Fall muß es bei der Analyse von (\mex{-1}) eine Verbalphrase
...
Restfeld und ein Schlußfeld. Die Analysen, die in (\mex{0}) skizziert sind, gehen davon aus, daß
...
\eal
\ex[*]{
daß Karl den Keks essen nicht darf
}
\ex[*]{
daß Karl den Keks essen nicht wird
}
\ex[]{
daß Karl, den Keks zu essen, nicht versucht
}
\zl
...
\eal
\ex[]{
daß Karl den Keks zu essen scheint
}
\ex[*]{
daß Karl scheint den Keks zu essen\NOTE{JB: findet das okay, bei vergessen statt essen wunderbar}
}
\zl
...
\eal
\ex[]{
daß Karl den Keks zu essen versucht
}
\ex[]{
daß Karl versucht, den Keks zu essen
}
\ex[]{\iw{werden!future}
daß Karl den Keks essen wird
}
\ex[*]{\iw{werden!future}
daß Karl wird den Keks essen
}
\ex[]{\iw{haben!perfect}
daß Karl den Keks gegessen hat
}
\ex[*]{\iw{haben!perfect}
daß Karl hat den Keks gegessen
}
\zl
\is{Extraposition|)}
...
bzw.\ Verbalprojektionen möglich, die nicht intraponiert oder extraponiert werden können.\footnote{
        Die Beispiele in (\mex{1}) sind von \citet*[\page 720--721]{Haftka81a}\ia{Haftka}.
}
\eal
...
Man beachte, daß das vorangestellte Material eine separate\is{Skopus}\is{Adverb!Skopus} Skopusdomäne bildet.
...
können nicht ohne dieses Element vorangestellt werden:\footnote{
        \citet*[\page 720--721]{Haftka81a}\iaf{Haftka} gibt Beispiele ähnlicher Struktur,
        die andere ausgeschlossene Voranstellungen zeigen, die in den nächsten Kapiteln
        diskutiert werden.
}
\eal
\ex[]{
daß er ihr ein Märchen erzählen müssen wird
}
...
nicht möglich ist, wie das von \citet[\page 942]{SW94a}\iawrong{Stiebels}\iawrong{Wunderlich}
...
\noindent
\citet[\page 283]{Haider93a}\iawrong{Haider} behauptet etwas Ähnliches, nämlich, daß
...
an \emph{haben}. \citet[\page 93]{Meurers2000b}\iaright{Meurers} gibt das Beispiel
in (\mex{1}).
\ea
Im Radio gehört wird er die Nachricht sicher nicht haben.
\z
Das Trennbarkeitsprinzip (\textit{Principle of Separability\/}\is{Prinzip!Trennbarkeits-}),
das \citet[\page 942]{SW94a}\iawrong{Stiebels}\iawrong{Wunderlich}
...
Kontrollverben eine Rolle zuweisen, ist, daß Kontrollverben keine subjektlosen\is{Verb!subjektloses} Konstruktionen einbetten
können, wohingegen die Einbettung subjektloser Konstruktionen unter die meisten Anhebungsverben
möglich ist:
\eal
\ex[]{\iw{grauen}
daß    (es) dem Studenten       vor der Prüfung graut
}
\ex[*]{
...
Optional kann es auch mit Subjekt verwendet werden, doch das Subjekt muß dann ein Expletivum\is{Pronomen!Expletiv-} -- ein semantisch
...
ist, offensichtlich ist (\citealp[\page 66]{Reis76c}\ia{Reis}; \citealp[\page 70]{Hoehle78a}\ia{Höhle}).
...
%
Für Sätze wie (\mex{0}) kann man annehmen, daß das Subjekt des eingebetteten Verbs
...
Wegen der Daten in (\mex{-1}) scheint es angebracht anzunehmen, daß das Subjekt
...
\citet*[Kapitel~6]{Hoehle83a}\ia{Höhle|(} 
...
jedoch auf das Subjekt. Daraus daß {\em ein- nach d- ander-\/} in (\mex{0}) im Nominativ
...
wie man aus dem Kasus von \emph{einer nach dem anderen} schließen kann.\footnote{
        Adam Przepi{\'o}rkowski\ia{Przepi{\'o}rkowski} (P.\,m.\,1999) hat mich darauf hingewiesen,
        daß es im Polnischen\il{Polnisch} zwei Klassen von im Kasus übereinstimmenden Elementen
        ...
        \citet{Hennis89}\iaf{Hennis} diskutiert Daten der Sprache Malayalam\is{Malayalam}. In
...
% 
        \citet{Andrews82b}\ia{Andrews}, \citet{Neidle82a}\iaright{Neidle} und 
        \citet[\page 396]{Bresnan82c}\ia{Bresnan} diskutieren isländische\il{Isländisch} und
        ...
        \citet[\page 404]{Neidle82a}\iaright{Neidle} diskutiert russische Daten und nimmt mit Comrie
...
Zu guter Letzt zeigen auch Beispiele wie (\mex{1}), daß eine Identität von kontrollierendem Element und kontrolliertem
Subjekt nicht adäquat ist, da in (\mex{1}) eine PP eine NP kontrolliert.\footnote{
        \citet*[\page 139]{ps2}\ia{Pollard}\ia{Sag} geben das folgende englische\is{Englisch}
        Beispiel.
        \ea
...
\zl
Im skizzierten Bedeutungsbeitrag von (\mex{0}a) in (\mex{0}b) sieht man, daß Peter sowohl eine Rolle
...
Das Beispiel in (\mex{1}) zeigt, daß bei \word{scheinen} sowohl enger als auch weiter
...
Die Beispiele in (\mex{1}) zeigen, daß NPen, die vom eingebetteten Verb abhängen,
...
die Extraposition des Infinitivs (\mex{1}c), so daß manchmal behauptet wird, daß Anhebungsverben
immer obligatorisch kohärent konstruieren (siehe \zb \citew[\page 128]{Haider90b}\iawrong{Haider}).
\eal
\label{bsp-intra-extra-scheinen}
\ex[]{
daß Karl Maria zu lieben scheint
}
\ex[*]{
daß Karl Maria zu lieben zumindest scheint
}
\ex[*]{
daß Karl scheint, Maria zu lieben\NOTE{FB: findet den okay}
}
\zl
...
\word{beginnen} sind jedoch Ausnahmen \citep[\page 18]{Kiss95a}\ia{Kiss}. 
...
man daran, daß sie Prädikate mit expletivem Subjekt (\mex{0}) und subjektlose Konstruktionen (\mex{1})
einbetten können.
...
%
	...
	\citet*[\page 151]{Uszkoreit87a} verwendet den Begriff \textit{Focus Raising\/}.
...
Peter etwas versprach. Siehe hierzu auch \citew[\page 5]{Netter91}\iaright{Netter}.

\citet[\page 43]{Meurers2000b}\ia{Meurers} benutzt die von mir gefundenen Beispiele 
...
\zl
\citet[\page 189]{Fanselow87a}\ia{Fanselow} diskutiert das Beispiel in 
(\mex{1}a) und \citet[\page 279]{Rosengren92a}\ia{Rosengren} und
\citet[\page 16]{Cook2001a}\ia{Cook} diskutieren die Beispiele in (\mex{1}b) bzw.\ (\mex{1}c):\footnote{
...
%% dürfte sein, daß sie in das Linearisierungsmuster der inkohärenten Konstruktion gezwungen wurden,
...
\z
%
Der Satz (\mex{0}) kann bedeuten, daß Karl jemanden verspricht, nicht einzuschlafen. Er kann aber
...
%AcI"=Verben werden auch \textit{Exceptional Case Marking Verbs\/} (ECM"=Verben) genannt. 
...
das folgende Beispiel von \citet[\page 340]{Puetz82a}\iaright{Pütz}
zeigt:
\ea
...
vor dem Akkusativ des eingebetteten Verbs stehen muß \citep[\page 356]{Eisenberg99a}\iawrong{Eisenberg}.
Die Beispiele (\mex{1}b), (\mex{2}) und (\mex{3}) zeigen, daß das nicht richtig ist.
%
...
Ich ließ es       (das Buch)      den Jungen    holen.\footnote{
        \citew*[\page 136]{Bech55a}\iaf{Bech}.
}
\zl
In (\mex{1}) sind die beiden Akkusative Pronomina. Aus dem Kontext wird klar, daß \word{sie}
...
\ea Man ließ der Feuerwehr           am     nächsten Tag die Polizei      helfen.\footnote{
        \citew[\page 125]{Bierwisch63a}\iadata{Bierwisch}.
      }
...
NPen, die auf unbelebte Elemente referieren, voranzustellen \citep*[\page 46]{Hoberg81a}\iaright{Hoberg}.
\ea
...
was auch oft bestritten wird (\citealp[\page 138]{Grewendorf87a}\iawrong{Grewendorf},
\citealp*[\page 284]{Grewendorf88a}\iawrong{Grewendorf}; \citealp[\page 207]{Wurmbrand98a}\iawrong{Wurmbrand};
\citealp[\page 117, 306]{Cook2001a}\iawrong{Cook}).
\ea
daß  ihn      (den Erfolg) uns      niemand      auskosten ließ\footnote{
        \citet*[\page 5]{Haider91}\ia{Haider} schreibt ein ähnliches Beispiel
        Tilman Höhle\ia{Höhle} zu. Siehe auch \citew[\page 136]{Haider90b}.
}
%\ex daß niemand uns den Erfolg auskosten ließ
%\ex daß uns niemand den Erfolg auskosten ließ
%\ex daß uns ihn niemand auskosten ließ
\z
M.\ \citet[\page 249]{MRichter2002b} behauptet, daß die Voranstellung vor das Subjekt des Matrixverbs
...
\eal
\ex[]{
daß ich den Jungen das Buch holen ließ / sah
}
\ex[*]{
daß ich das Buch holen den Jungen ließ / sah
}
\ex[*]{
daß den Jungen das Buch holen niemand ließ / sah
}
\zl
...
\eal
\ex[*]{
daß ich ließ / sah, den Jungen das Buch holen
}
\ex[*]{
daß ich den Jungen ließ / sah, das Buch holen
}
\zl
\is{Koh"arenz|)}
...
Sie erlauben die Einbettung expletiver und subjektloser Prädikate (\citealp[\page 66]{Reis76c}\iaf{Reis}; 
\citealp[\page 70]{Hoehle78a}\iaf{Höhle}).\footnote{
...
%% klugscheißerisch
%% \footnote{
%%        Siehe auch \citew[\page 12]{Kiss95a}\iaf{Kiss}. Auf S.\,217 gibt Kiss allerdings 
...
%%         Kopula mit \emph{sein}\iwf{sein}. Entgegen der Behauptung von \citet[\page 66]{Reis76c}\iafwrong{Reis}
...
%%         \zl
%%         Die allgemeinere Behauptung von Suchland (\citeyear[\page 72]{Suchsland95a}\iafwrong{Suchsland};
%%         \citeyear[\page 149]{Suchsland97a}), daß alle AcI"=Verben keine Kopulakonstruktionen einbetten
...
% klugscheißerisch
%% $^,$\footnote{
%%         Die Beispiele in (\mex{1}) zeigen, daß eine Kontrollanalyse für \emph{sehen},
%%         wie sie von \citet[\page 231]{HM94a}\iawrong{Heinz}\iawrong{Matiasek}
...
\z
Manchmal wird behauptet, daß es sich beim \emph{es} der Wetterverben\is{Verb!Wetter-}
nicht um expletive Elemente handelt (\citealp[\page 35]{Paul1919a}\iawrong{Paul}),
...
behauptet, daß das Matrixverb eine thematische Rolle zuweist.\is{Verb!Wahrnehmungs-}
\citet[\page 387]{Eisenberg94a}\iawrong{Eisenberg} \zb behauptet, daß
...
Wie \citet{KT76a}\iaright{Kirsner}\iaright{Thompson} schlüssig darlegen, ist die Information, 
...
\ex Von meinem Beobachtungspunkt, der fünfzehn Kilometer weit entfernt war,
      sah\iw{sehen|)} ich sie die Brücke sprengen, aber es erübrigt sich zu sagen, daß
      ich die einzelnen Arbeiter aus der Entfernung nicht sehen konnte.
\ex Wir hörten den Bauer das Schwein schlachten.\footnote{
        De Geest \citeyearpar[\page 45]{deGeest70a}\iaf{de Geest} gibt ein analoges niederländisches\il{Niederländisch}
...
nicht möglich sind (\citealp[\page 276]{Sternefeld85b}\iaf{Sternefeld}).
...
bei einfachen Lexikoneinträgen gibt.\footnote{
  ...
  an, daß es in Inuit Eskimo\il{Inuit Eskimo}, der von ihnen untersuchten Sprache, schon
  Ausnahmen zu einer solchen Beschränkung gibt.%
}$^,$\footnote{
        Haider (\citeyear[\page 94]{Haider86c}; \citeyear[\page 131]{Haider90b}),
        \citet[\page 215]{Kiss95a}\ia{Kiss} und
        \citet[\page 32]{Kathol2000a}\iawrong{Kathol} machen dieselbe Annahme.
        ...
        deutscher Anhebungsinfinitive. \citet[\page 7]{Fanselow89b} zeigt, daß
        ...
        \zl
        Dies ist erklärt, wenn man sagt, daß das \emph{Case Frame Preservation Principle}\is{Prinzip!Case Frame Preservation Principle}
...
\label{fn-scrambling-pronoun}%
        Man beachte, daß beide Sätze in (\mex{1}) mehrdeutig sind.
...
% Bayer96a:246 daß mich Hans niemanden zu grüßen gezwungen hat
...
zwei Akkusative\is{Kasus!Akkusativ}, was es im Deutschen bei einfachen Verben nicht gibt.\footnote{
        ...
        reflexives Verb\is{Verb!inhärent reflexives} handelt, könnte man behaupten, daß der Kasus
...
Wie \citet[\page 13]{Askedal88}\iaright{Askedal} festgestellt hat, muß es sich bei (\mex{1})
...
Keine Zeitung         wird ihr       zu lesen erlaubt.\footnote{
        ...
        zitiert nach \citew[\page 309]{Bech55a}\iaf{Bech}.
}
\z
...
Die Beispiele in (\mex{1}) zeigen, daß die Permutation der Elemente im \mf möglich ist.
\eal
\ex\iw{erlauben}
...
daß ihn       (den Erfolg) uns      niemand      auszukosten erlaubte\footnote{
        \citet*[\page 5]{Haider91}\iaf{Haider} schreibt das Beispiel Tilman Höhle\aimention{Tilman N. H{\"o}hle} zu.
}
\zl
...
Man kann somit die Generalisierung aufrecht erhalten, daß in Adjunktionspositionen\is{Adjunkt}
...
subcat & \liste{ NP[\ldat] }
}
\z
Sowohl die finite als auch die infinite Form sind mittels Lexikonregeln vom Verbstamm abgeleitet
(zu Lexikonregeln siehe Kapitel~\ref{sec-lr}). Die \subcatl des finiten Verbs in (\mex{-1}) entspricht der \subcatl
...
(\citealp{Andrews82b}\ia{Andrews}; \citealp{Neidle82a}\iaright{Neidle}; \citealp[\page 396]{Bresnan82c}\iaright{Bresnan})
und in den Arbeiten von \citet[Kapitel~7]{ps2}\ia{Pollard}\ia{Sag}, \citet{Kiss95a}
...
%% \footnote{
%%         \citet[\page 37]{dSW88a}\iaright{Di Sciullo}\iaright{Williams} propose a function composition\is{function composition}
...
\ms{
cat & \ms{% head   & verb \\ 
           subcat & \ibox{1} $\oplus$ \ibox{2} $\oplus$ \sliste{ \textrm{V[\textit{inf}, \textsc{lex}+, \textsc{subj}~\ibox{1}, \textsc{subcat}~\ibox{2} ]:\ibox{3}}}\\
         }\\
cont & \ms[scheinen]{
        soa & \ibox{3}\\
       }\\
...
\noindent
Der \subjw des eingebetteten Verbs \iboxb{1} wird mit dem \subcatw des
eingebetteten Verbs \iboxb{2} verknüpft und zum \subcatw des Verbs \emph{scheinen} angehoben.
...
Für die angezogenen Argumente (\ibox{1} $\oplus$ \ibox{2} in (\ref{le-scheinen})) muß wie bei \emph{werden}
...
deshalb Nominativ und muß auch mit \emph{scheinen} kongruieren\is{Kongruenz},
...
\ex[*]{
daß Karl scheint, Maria zu lieben
}
\zl
...
\rnode{1}{\ms{ head   & \ibox{1}\\
           subcat & \ibox{2} $\oplus$ \ibox{3}\\
            }}}\\
\\[3ex]
%10pt
\multicolumn{2}{@{}l@{}}{\hspace{24ex}CL\hspace{27ex}H}\\[4ex]
%12pt
%\multicolumn{2}{@{}l@{}}{\hspace{42mm}CL\hspace{40mm}H}\\[4ex]
\\
\rnode{2}{
\iboxt{4}~\onems{ loc \onems{ head  \ms[verb]{ subj  & \ibox{2} \sliste{ NP[\textit{nom\/}] }\\
                                               vform & inf \\
                                             }\\
                                subcat~\ibox{3} \sliste{ NP[\ldat] }\\[2mm]
                              }\\
                }} &
\rnode{3}{
                 \ms{ head & \ibox{1} \ms[verb]{ subj  & \sliste{ }\\
                      ...
                      subcat & \ibox{2} $\oplus$ \ibox{3} $\oplus$ \sliste{ \ibox{4} }\\
                    }}\\
\\[3ex]
\rnode{4}{zu helfen} & \rnode{5}{scheint}\\
\end{tabular}
\ncline{1}{2}\ncline{1}{3}%
\ncline{2}{4}\ncline{3}{5}%
}
...
\subcatl \iboxb{3}. Da \emph{scheint} finit ist, ist das Subjekt des Verbs in der \subcatl
von \emph{scheint} repräsentiert und demzufolge auch ein Element der \subcatl des gesamten Komplexes. 
...
\\[3ex]
%10pt
\multicolumn{2}{@{}l@{}}{\hspace{25ex}CL\hspace{29ex}H}\\[4ex]
%12pt
%\multicolumn{2}{@{}l@{}}{\hspace{42mm}CL\hspace{40mm}H}\\[4ex]
\\
\rnode{2}{
\iboxt{4}~\onems{ loc \onems{ head  \ms[verb]{ subj  & \ibox{3} \sliste{ NP[\textit{nom\/}] }\\
                                               vform & inf \\
                                             }\\
                                subcat~\ibox{2} \sliste{ NP[\ldat] }\\[2mm]
                              }\\
                }} &
\rnode{3}{
                 \onems{ head \ibox{1} \ms[verb]{ subj  & \ibox{3} \sliste{ NP[\textit{nom\/}] }\\
                                                 vform & bse \\
                                                    }\\
                      subcat \ibox{2} $\oplus$ \sliste{ \ibox{4} }\\
                    }}\\
\\[3ex]
\rnode{4}{zu helfen} & \rnode{5}{scheinen}\\
\end{tabular}
\ncline{1}{2}\ncline{1}{3}%
\ncline{2}{4}\ncline{3}{5}%
}
...
\end{figure}
Diese Analyse gleicht der von \emph{zu helfen scheint}, nur daß das Subjekt von \emph{scheinen} als
...
\ms{
cat & \ms{% head   & verb \\
           subcat & \ibox{1} $\oplus$ \ibox{2} $\oplus$ \sliste{ \textrm{V[\textit{inf}, \textsc{subj}~\ibox{1}, \textsc{subcat}~\ibox{2} ]:\ibox{3}} }\\
         }\\
cont & \ms[beginnen]{
        soa & \ibox{3}\\
       }\\
...
%\resizebox{\linewidth}{!}{%
\onems{
cat$|$subcat  \sliste{ NP[\textit{str\/}]\ind{1}  } $\oplus$ \ibox{2} $\oplus$ \sliste{ \textrm{V[}%\textit{inf}, \textsc{subj} \sliste{NP[\textit{str\/}]\ind{1}}, \textsc{subcat}~\ibox{2} ]:\ibox{3}}\\[2mm]
\begin{tabular}[t]{@{}l@{}}
...
%% $^,$\footnote{
%%         \citet[\page 217]{Kiss95a}\iawrong{Kiss} gives a similar lexical entry for \emph{sehen},
...
\onems{ cat$|$subcat \sliste{ NP[\textit{str\/}]\ind{1} } $\oplus$ \ibox{2} $\oplus$ \ibox{3} $\oplus$ \sliste{ \textrm{V[}%
\begin{tabular}[t]{@{}l@{}}
\textit{bse}, \textsc{lex}+, \textsc{subj}~\ibox{2},\\
\textsc{subcat}~\ibox{3}]:\ibox{4} \\[2mm]
\end{tabular}}\\
     cont  \ms[sehen]{
                      experiencer & \ibox{1}\\
                      soa         & \ibox{4}\\
...
bestimmten Performanzfaktoren\is{Performanz}, so daß die Umstellungen nicht im gleichen Maße
...
cat & \ms{% head   & verb \\
           subcat & \begin{tabular}{@{}l@{}}
                    ...
                    \end{tabular}
% \begin{tabular}{@{}l@{}l}
%                             \textrm{V[}&\textrm{\textit{inf}, \textsc{lex}+, \textsc{subj}~\sliste{NP[\textit{str\/}]\ind{2}},}\\
%                                     & \textrm{\textsc{subcat}~\ibox{3} ]:\ibox{4}}\\
%                             \end{tabular}}\\
         }\\
cont & \ms[erlauben]{
        agens       & \ibox{1}\\
...
Verbalkomplexes. Das Kasusprinzip\is{Prinzip!Kasus-} weist dem ersten Element in der \subcatl, das strukturellen
...
und Einbettung eines transitiven Verbs ergibt sich für den Komplex die \subcatl in (\mex{1}):
\ea
\subcat \sliste{ NP[\type{ldat}], NP[\type{str}] }
\z
...
jedoch gezeigt hat, ist das semantisch nicht adäquat, denn es ist nicht immer so, daß das Agens des
eingebetteten Verbs wahrgenommen wird.

Alternativ wurde vorgeschlagen, daß das AcI"=Verb einen Satz mit infinitem Verb einbettet, \dash eine
Projektion des Verbs, die das Subjekt enthält. Bei solchen Ansätzen muß entweder das AcI"=Verb in
eine abgeschlossene Projektion hinein Kasus zuweisen, was auch als \emph{Exceptional Case Marking}
bezeichnet wird oder man geht davon aus, daß es spezielle Infinitivformen des Verbs gibt, die ihrem
...
\citet[\page 1423--1425]{Zifonun97c} nimmt an, daß AcI"=Verben eine Verbalprojektion einbetten,
...
aber nicht von einer Kontrollanalyse sprechen, wenn nicht gleichzeitig noch behauptet wird, daß das
...
Außerdem hat die Datendiskussion gezeigt, daß Argumente des Infinitivs vor Argumenten des AcI"=Verbs
angeordnet werden können. Geht man davon aus, daß 

%Hier muß man mit den unpersönlichen Einbettungen argumentieren. Dafür gibt es aber bei Google keinen Beleg.
...
Für Anhebungsverben wie \word{scheinen} nimmt Reape an, daß das Anhebungsverb einen nicht"=finiten
...
\z
Das Problem ist nun, daß die Nominativ"=NP in (\mex{0}) mit \emph{scheint} kongruiert, was man noch besser
...
und folgen \citet{MC63a-u} in der Annahme, daß die Tatsache, daß solche Einbettungen nur bis zur
...
Der Hund, [\sub{RS} der die Katze, [\sub{RS} die die Maus gefangen hat,] jagt ] bellt.
\z
Interessant in diesem Zusammenhang ist, daß man die Beispiele für Selbsteinbettung so konstruieren
kann, daß sie für Hörer leichter verarbeitbar sind. Auf diese Weise kann man die Zahl der prinzipiell
verarbeitbaren Selbsteinbettungen um eins erhöhen und zeigen, daß alle Grammatiken, die eine Beschränkung
...
diese Muster und stellen fest, daß LTAG die Abfolge in (\mex{1}) nicht analysieren kann, wenn man
...
(Tree"=local MC"=LTAG). Sie zeigen, daß MC-LTAG zwar (\mex{0}) nicht aber (\mex{1}) mit korrekter Semantik
analysieren kann. Sie behaupten, daß solche Muster im Deutschen nicht möglich sind und argumentieren, daß 
...
verstanden werden und formulieren ihre Sätze deshalb so, daß der Hörer sie auch verstehen kann.
Da man hochkomplexe kohärente Konstruktionen oft dadurch vereinfachen kann, daß man Teile extraponiert
...
ist, daß er die Einbettung von zwei Verben mit Umstellung erlaubt, aber die Einbettung von drei
...
Umstellungen verbieten. Ich gehe statt dessen davon aus, daß viele Umstellungen durch Regeln ausgeschlossen
...
muß man außerdem beachten, daß die beteiligten Nomina möglichst in bezug auf ihren Kasus und auf 
...
daß die Wahrscheinlichkeit, daß in einem Zeitungstext ein entsprechender Satz gefunden werden kann,
extrem gering ist, was schon daran liegt, daß es wenige Situationen gibt, in denen entsprechende Äußerungen
denkbar sind. Hinzu kommt, daß mit Ausnahme von \emph{helfen} alle Kontrollverben einen Infinitiv mit
...
Man beachte, daß MC-LTAG die Anzahl der Verben im Satz nicht beschränkt. Der Formalismus läßt
beliebig viele Verben zu. Man muß also genauso, wie ich es hier für die HPSG"=Analyse tue, davon ausgehen,
daß Performanzbeschränkungen dafür zuständig sind, daß man keine Belege für Verbalkomplexe mit fünf
...
Das Problem bei Umstellungen ist, daß es irgendwie möglich sein muß die Nominalphrasen ihren Köpfen
...
\eal
\ex[]{
Hanna hat immer schon gewußt, daß das Kind sie verlassen will.\footnote{        
...
\ex[\#]{
Hanna hat immer schon gewußt, daß sie das Kind verlassen will.
}
\ex[]{
Hanna hat immer schon gewußt, daß sie der Mann verlassen will.
}
\zl
Man kann den Satz (\mex{0}a) nicht zu (\mex{0}b) umstellen, ohne eine andere
Bedeutung zu bekommen. Das liegt daran, daß sowohl \emph{sie} als auch \emph{das Kind}
morphologisch nicht eindeutig als Nominativ oder Akkusativ markiert sind. (\mex{0}b)
wird deshalb so interpretiert, daß Hanna das Kind verlassen will. Ist dagegen mindestens
...
Das Problem mit den Verbalkomplexen ist jetzt, daß man, wenn man vier Nominalphrasen hat,
...
selegieren, so daß man durch die Belebtheit der Argumente Interpretationshilfen bekommt.
...
sind. MC-LTAG kann Sätze wie (\mex{0}) nicht korrekt verarbeiten, womit gezeigt ist, daß diese Art Grammatik für die Analyse von natürlichen
Sprachen ungeeignet ist. 
%Man könnte sich jetzt auf die Suche nach einem geringfügig komplexeren Grammatikformalismus
%begeben, der (\mex{0}) gerade noch analysieren kann. Ich denke jedoch, daß man
...
unspezifiziert ist. In diesem Zusammenhang sind die folgenden Beispiele von \citet[\page
  407]{Fanselow2001a} interessant, die zu zeigen scheinen, daß Umstellungen auf Argumente beschränkt
sind.
\eal
...
\zl
Der Satz in (\mex{0}b) ist abweichend, was Fanselow darauf zurückführt, daß \emph{morgen}
...
Ich denke aber, daß auch hier Performanzphänomene\is{Performanz} eine Rolle spielen, denn wenn Skopus
