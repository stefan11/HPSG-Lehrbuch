...
In (\mex{0}) wird nicht verlangt, dass die \subcatl des eingebetteten Verbs mit einer NP mit strukturellem Kasus
...
verlangt, dass die \subcatl des Partizips eine NP mit strukturellem Kasus
...
der Nachteil ist aber, dass \emph{geliebt} kein Element in der \subcatl hat,
...
dass der \ergw des eingebetteten Partizips ein Präfix der \subcatl des Partizips ist,
...
muss der Reihenfolge in der \subcatl der Kopftochter entsprechen. Deshalb muss
...
Dadurch dass Elemente nicht von der \subcatl entfernt, sondern nur markiert werden,
...
mit dem \subcatw besteht, so unterteilen läßt, dass es einen Listenanfang gibt, der aus Elementen besteht,
...
so dass \zb in der Liste \sliste{ NP[\str], NP[\str], NP[\str] }, wie sie in (\mex{1}) als \subcatl
