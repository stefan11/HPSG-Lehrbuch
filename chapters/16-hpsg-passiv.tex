...
für diesen Prozess ebenfalls lexikalisch sein (\citealp[\page412]{Dowty78a};
...
\itdopt{Dazu muss das ARP auch auf Stämme angewendet werden.}
Durch das Argumentrealisierungsprinzip wird die \argstl in einen Teil mit dem Subjekt und einen Rest
gespalten. Bei Adjektiven wie \emph{treu} und \emph{stolz} kann die \compsl auch eine NP oder PP
enthalten. Bei subjektlosen Adjektiven wie \emph{schulfrei} \citep{Haider} kann die \subjl auch leer sein. 
