...
Leere \hconslen lasse ich im Folgenden weg.}

\eas
\label{le-los-asp}%
\mbox{\emph{los} (Aspektmarker):}\\
\ms{
synsem|loc & \ms{ cat & \ms{ head & \ms[particle]{ mod  & \upshape V[\textsc{arg-st} \sliste{ NP[\str] }, \textsc{cont|ltop} \ibox{1}] \\
%                                                   subj & \eliste \\
                                                  } \\
%                             comps  & \eliste\\
                             arg-st & \eliste \\
...
[V\feattab{\cont [\ltop \ibox{1}, \textsc{ind} \ibox{2} ]\\
           \rels \nliste{ h1:beginnen(h2), h2:lachen(x) }}
  ...
  [V\feattab{ \comps \sliste{ \ldots{} \ibox{3} Part[\textsc{mod} \ibox{4}, \cont \ibox{6}] },\\
    ...
    [\ibox{4} V\feattab{\cont|\ltop \ibox{4} h2,\\
...
\ms{
cat & \ms{ head & \ms[particle]{ mod  & \upshape V[\argst \sliste{ NP[\str] }, \textsc{cont|ltop} \ibox{1}] \\[2mm]
%                                 subj & \sliste{ NP[\str]\ind{2} } \\
                              } \\
%           comps & \eliste \\
           arg-st & \sliste{ NP[\str]\ind{2} }\\
         }\\
cont & \ms{ ltop & \ibox{3}\\
            ind  & \ibox{4} }\\
...
Das zusätzliche Argument von \emph{an$_5$} ist an das Argument der Relation \emph{gerichtet-auf} gelinkt \iboxb{2}. Das andere Argument dieser
Relation ist mit dem Label des Basisverbs identifiziert \iboxb{1}.
