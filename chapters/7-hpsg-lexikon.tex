...
nicht das Partizip Perfekt statt des Partizips Passiv verwendet werden:\enlargethispage{1.5\baselineskip}
\eal
\ex[]{
...
\begin{figure}[htb]
\centerline{\begin{pspicture}(-0.8,0.8)(10.4,5.4)
%\psgrid
\rput[B](5,5){\rnode{lexeme}{\textit{lexeme}}}
%
\rput[B](0.5,3){\rnode{passive}{\textit{passive}}}
\rput[B](3.5,3){\rnode{active}{\textit{active}}}
%
%\rput[B](4,3){\rnode{3sg}{\textit{3sg}}}
%\rput[B](6,3){\rnode{past}{\textit{past}}}
\rput[B](6.5,3){\rnode{lesen}{\textit{lesen}}}
\rput[B](9.5,3){\rnode{essen}{\textit{essen}}}
\rput[B](0.5,1){\rnode{1}{\type{passive} $\wedge$ \type{lesen}}}
\rput[B](3.5,1){\rnode{2}{\type{active} $\wedge$ \type{lesen}}}
\rput[B](6.5,1){\rnode{3}{\type{passive} $\wedge$ \type{essen}}}
\rput[B](9.5,1){\rnode{4}{\type{active} $\wedge$ \type{essen}}}
%
\psset{angleA=-90,angleB=90,arm=0pt}
%
\ncdiag{lexeme}{passive}\ncdiag{lexeme}{active}
\ncdiag{lexeme}{3sg}\ncdiag{lexeme}{past}
\ncdiag{lexeme}{lesen}\ncdiag{lexeme}{essen}
\ncdiag{passive}{1}\ncdiag{lesen}{1}
\ncdiag{active}{2}\ncdiag{lesen}{2}
...
%\psgrid
\rput[B](5,5){\rnode{lexeme}{\textit{lexeme}}}
\rput[B](2,3){\rnode{valence}{\fbox{\textit{number}}}}
%\rput[B](5,3){\rnode{inflection}{\fbox\textit{inflection}}}
\rput[B](8,3){\rnode{root}{\fbox{\textit{root}}}}
%
\rput[B](1,1){\rnode{passive}{\textit{sg}}}
\rput[B](3,1){\rnode{active}{\textit{pl}}}
%
%\rput[B](4,1){\rnode{3sg}{\textit{3sg}}}
%\rput[B](6,1){\rnode{past}{\textit{past}}}
\rput[B](7,1){\rnode{lesen}{\textit{cat}}}
\rput[B](9,1){\rnode{essen}{\textit{dog}}}
\psset{angleA=-90,angleB=90,arm=0pt}
%
\ncdiag{lexeme}{valence}\ncdiag{lexeme}{inflection}\ncdiag{lexeme}{root}
\ncdiag{valence}{passive}\ncdiag{valence}{active}
...
%\psgrid
\rput[B](5,5){\rnode{lexeme}{\textit{lexeme}}}
\rput[B](2,3){\rnode{valence}{\fbox{\textit{root}}}}
%\rput[B](5,3){\rnode{inflection}{\fbox\textit{inflection}}}
\rput[B](8,3){\rnode{root}{\fbox{\textit{affix}}}}
%
\rput[B](1,1){\rnode{passive}{\textit{les}}}
\rput[B](3,1){\rnode{active}{\textit{traurig}}}
%
%\rput[B](4,1){\rnode{3sg}{\textit{3sg}}}
%\rput[B](6,1){\rnode{past}{\textit{past}}}
\rput[B](7,1){\rnode{lesen}{\textit{bar}}}
\rput[B](9,1){\rnode{essen}{\textit{keit}}}
\psset{angleA=-90,angleB=90,arm=0pt}
%
\ncdiag{lexeme}{valence}\ncdiag{lexeme}{inflection}\ncdiag{lexeme}{root}
\ncdiag{valence}{passive}\ncdiag{valence}{active}
...
\begin{figure}[htb]
\centerline{\begin{pspicture}(-0.6,0.8)(5.4,5.4)
%\psgrid
\rput[B](3,5){\rnode{Lebewesen}{\textit{Lebewesen}}}
\rput[B](3,3){\rnode{sign}{\textit{Vogel}: hat Flügel, fliegt}}
%
\rput[B](1,1){\rnode{word}{\textit{Pinguin}: fliegt nicht}}
%
\rput[B](5,1){\rnode{phrase}{\textit{Spatz}}}
\psset{angleA=-90,angleB=90,arm=0pt}
%
\ncdiag{Lebewesen}{sign}
\ncdiag{sign}{word}\ncdiag{sign}{phrase}
%
\end{pspicture}}
...
\begin{figure}[htb]
\centerline{\begin{pspicture}(-0.6,0.8)(7.2,5.4)
%\psgrid
\rput[B](3,5){\rnode{Lebewesen}{\textit{Lebewesen}}}
\rput[B](1,3){\rnode{sign}{\textit{Vogel}: hat Flügel}}
\rput[B](5,3){\rnode{fliegt}{\textit{fliegendes Lebewesen}: fliegt}}
%
\rput[B](1,1){\rnode{word}{\textit{Pinguin}: fliegt nicht}}
%
\rput[B](5,1){\rnode{phrase}{\textit{Spatz}}}
...
\begin{figure}[htbp]
\centerline{\begin{pspicture}(-0.6,-1.2)(5.4,3.4)
%\psgrid
\rput[B](3,3){\rnode{sign}{\textit{Mensch}}}
%
\rput[B](1,1){\rnode{word}{\textit{Quaker}: Pazifist}}
%
\rput[B](5,1){\rnode{phrase}{\textit{Republikaner}: kein Pazifist}}
\rput[B](3,-1){\rnode{nixon}{\textit{Nixon}: ?}}
\psset{angleA=-90,angleB=90,arm=0pt}
%
\ncdiag{sign}{word}\ncdiag{sign}{phrase}
\ncdiag{word}{nixon}\ncdiag{phrase}{nixon}
...
\begin{figure}[htbp]
\centerline{\begin{pspicture}(-1.2,1.9)(10.8,6.4)
%\psgrid
\rput[B](1,6){\rnode{verb}{\textit{verb}: \type{list} }}
%
\rput[B](1,4){\rnode{intrans}{\textit{intrans-verb}: \sliste{ NP } }}
%
\rput[B](1,2){\rnode{trans}{\textit{trans-verb: \sliste{ NP, NP, \ldots }}}}
%\rput[B](1,0){\rnode{ditrans}{\textit{ditrans-verb}:  \sliste{ NP, NP, NP }}}
\psset{angleA=-90,angleB=90,arm=0pt}
%
\ncdiag{verb}{intrans}\ncdiag{intrans}{trans}\ncdiag{trans}{ditrans}%
%
\rput[B](8,5){\rnode{verb2}{\textit{verb}: \type{list} }}
%
\rput[B](6,3){\rnode{intrans2}{\begin{tabular}[t]{@{}c@{}}
                               \textit{intrans-verb}:\\
                               \sliste{ NP } 
                               \end{tabular}}}
%
\rput[B](10,3){\rnode{trans2}{\begin{tabular}[t]{@{}c@{}}
                             \textit{trans-verb}:\\
                             \sliste{ NP, NP, \ldots }
                             \end{tabular}}}
%% \rput[B](11,2){\rnode{ditrans2}{\begin{tabular}[t]{@{}c@{}}
%%                                 \textit{ditrans-verb}:\\
%%                                 \sliste{ NP, NP, NP }
%%                                 \end{tabular}}}
\psset{angleA=-90,angleB=90,arm=0pt}
%
\ncdiag{verb}{intrans}\ncdiag{intrans}{trans}\ncdiag{trans}{ditrans}%
\ncdiag{verb2}{intrans2}\ncdiag{verb2}{trans2}\ncdiag{verb2}{ditrans2}%
%
\end{pspicture}}
...
\begin{figure}[htbp]
\centerline{\begin{pspicture}(0.8,1)(5.4,5.4)
%\psgrid
\rput[B](1,5){\rnode{les}{\textit{les}}}
%
\rput[B](3,5){\rnode{bar}{\textit{bar}}}
\rput[B](5,5){\rnode{keit}{\textit{keit}}}
\rput[B](2,3){\rnode{lesbar}{\textit{lesbar}}}
\rput[B](3,1){\rnode{lesbarkeit}{\textit{lesbarkeit}}}
%
\psset{angleA=-90,angleB=90,arm=0pt}
%
\ncdiag{les}{lesbar}\ncdiag{bar}{lesbar}
\ncdiag{lesbar}{lesbarkeit}\ncdiag{keit}{lesbarkeit}
%
\end{pspicture}}
...
\zl
Die \phon-, Kasus- und Genus"=Werte können dabei unberücksichtigt bleiben. Wichtig ist, daß die
...
Oben in der Menüleiste des Fensters, in dem die Grammatik geladen wird, gibt es einen Menüpunkt \verb+Trale+.
Gehen Sie zum  Unterpunkt \verb+Draw|Hierarchy+. 
...
Sie in der Datei \verb+le_macros.pl+, die Sie über das Menü \verb+File|Open File+ öffnen können.
Die genaue Syntax der Typbeschränkungen ist im Trale"= bzw.\ ALE"=Manual beschrieben.\footnote{
\url{http://www.ale.cs.toronto.edu/docs/}. 28.12.2006.%
}
