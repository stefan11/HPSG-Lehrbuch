  ...
  circle edge/.style={
    tikz+={
          \node [fit=(.child anchor) (!u.parent anchor), draw=\foresteoption{circle edge colour},
            ellipse, inner ysep=1.5pt, line width=0.25mm ] {};
        }
  },
...
% remove loading xspace from langscibook.cls
%\usepackage{my-xspace}

%\xspace funktioniert nicht mit \comps \ibox
% nur wenn \mbox{} in \ibox zu Beginn aufgerufen wird.
% is loaded in langscibook.cls
%\usepackage{xspace}
\xspaceaddexceptions{\ind \hyp " \ |}
