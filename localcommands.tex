...
\begin{tblsfilledsymbol}{Kontrollfragen}{people}\setlist{leftmargin=*}#1\end{tblsfilledsymbol}}}
\newcommand{\exercises}[1]{{\mmzset{disable}%
\begin{tblsfilledsymbol}{Übungsaufgaben}{pencil}\setlist{leftmargin=*}#1\end{tblsfilledsymbol}}}
\newcommand{\furtherreading}[1]{{\mmzset{disable}%
\begin{tblsfilledsymbol}{Literaturhinweise}{book}#1\end{tblsfilledsymbol}}}}{}
...
% for \ibox{1} needed for AVM alignment
\newlength{\iboxlength}%

% to be used for scaling down the AVMs and figures in hpsg-loesungen.tex
\newcommand{\scalefactor}{.9}
